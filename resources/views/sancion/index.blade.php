                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="w-full overflow-x-auto">
                        <table class="w-full divide-y divide-gray-700 dark:divide-gray-500">
                            ...
                            <tbody class="dark:bg-gray-800 divide-y divide-gray-700  dark:divide-gray-500">
                                ...
                                <tr class="text-center">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex">
                                            <a href="{{route('sanciones.edit', $item->id)}}" class="flex-1 font-medium text-blue-600 dark:text-blue-500 hover:underline"> Editar</a>
                                            <form class="flex-1" action="{{ route('sanciones.destroy', $item->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
