...
<div class="w-full pl-3 overflwow-hidden">
    <div class="text-gray-500 text-sm mb-1.5 dark:text-gray-400 overflwow-hidden">
        <span class="font-semibold text-gray-900 dark:text-white">{{ $notification->data['from']['name'] }} ha actualizado </span> el voucher con código de operación   
        <span class="font-semibold text-gray-900 dark:text-white">{{ $notification->data['voucher']['codigo_operacion'] }}
        </span> para su validación
    </div>
