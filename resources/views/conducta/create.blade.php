        ...
        <div class="mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-5">
                <div class="px-6 py-4 text-gray-900 dark:text-gray-100 flex justify-between">
                    <p class="font-xl text-gray-800 dark:text-white font-semibold py-2 px-4">Formulario de conducta</p>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('conductas.store') }}" class="max-w-7xl mx-auto" id="frmNuevoConducta">
                        @csrf
                        <div class="grid grid-cols-2 gap-4 lg:grid-cols-3">
                          <div>
                            <label for="nombre" class="block">Asunto</label>
                            <input required type="text" id="nombre" name="nombre" class="w-full">
                          </div>
                          <div>
                            <label for="puntaje" class="block" id="puntaje-label">Puntos</label>
                            <input required type="number" id="puntaje" name="puntaje" class="w-full" value="-1">
                          ...
                          <div>
                            <fieldset>
                              ...
                              <label for="demerito" class="block"> Demérito
                                <input checked type="radio" id="demerito" name="tipo" value="0" onchange="cambiarTexto()">
                              </label>
                              <label for="merito" class="block"> Mérito
                                <input type="radio" id="merito" name="tipo" value="1" onchange="cambiarTexto()">
                              </label>
                            </fieldset>
                          </div>
