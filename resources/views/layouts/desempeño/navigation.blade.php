    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @endcan
                @can('miscalificaciones')
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-nav-link :href="route('miscalificaciones', ['id' => Auth::user()->dni])">
                ...
                @can('evaluardocentes')
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-nav-link :href="route('evaluardocentes')">
                            {{ __('Evaluar docentes') }}
                        </x-nav-link>
                    </div>
                @endcan
                @can('miscursos')
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-nav-link :href="route('miscursos', ['id' => Auth::user()->dni])">
                            {{ __('Mis Cursos') }}
                        </x-nav-link>
                    </div>
                @endcan
                @can('verdocumentos')
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-nav-link :href="route('aprobardocumentos')">
                            {{ __('Aprobar Documentos') }}
                        </x-nav-link>
                    </div>
                @endcan
