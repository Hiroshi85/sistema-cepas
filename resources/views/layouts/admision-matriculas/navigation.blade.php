@php
    $navigation = [
        'Dashboard' => 'admision-matriculas.dashboard',
        'Matrículas' => [
            'Aulas' => 'aula.index',
        ...
        'Admisión' => [
            ...
            'Entrevistas' => 'entrevista.index',
        ],
        'Pagos' => 'pago.index',
    ];
@endphp

<nav x-data="{ open: false }" class="bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800 sticky top-0 z-[19]">
