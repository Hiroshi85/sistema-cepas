        ...
        <form method="post" action="{{ route('postulante.update', $postulante->idpostulante) }}" class="mt-6 space-y-6">
            ...
            <div class="flex flex-row gap-4 flex-wrap">
                ...
                <div class="grow">
                    ...
                    <x-text-input id="fecha_nacimiento" class="block mt-1 w-full" type="date" name="fecha_nacimiento" required autofocus :value="old('nombre_apellidos', $postulante->fecha_nacimiento)" />
                    <x-input-error :messages="$errors->get('fecha_nacimiento')" class="mt-2" />
                </div>

                <div class="grow">
                    <x-input-label for="dni" :value="__('DNI')" />
                    <x-text-input id="dni" class="block mt-1 w-full" type="text" name="dni" required autofocus :value="old('nombre_apellidos', $postulante->dni)"/>
            ...
            <div class="flex flex-row gap-4 flex-wrap">
                <div class="grow">
                    ...
                    <x-text-input id="numero_celular" class="block mt-1 w-full" type="text" name="numero_celular" required autofocus :value="old('nombre_apellidos', $postulante->numero_celular)" />
                    <x-input-error :messages="$errors->get('numero_celular')" class="mt-2" />
                </div>

                <div class="grow">
                    <x-input-label for="nro_hermanos" :value="__('Nro. de Hermanos')" />
                    <x-text-input id="nro_hermanos" class="block mt-1 w-full" type="number" name="nro_hermanos" required autofocus :value="old('nombre_apellidos', $postulante->nro_hermanos)"/>
