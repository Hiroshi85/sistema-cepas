<x-modal-edit :id="$item->iddocumento">
    ...
    <form  method="POST" action="{{ route('docspostulante.update',$item->iddocumento) }}" enctype="multipart/form-data">
        @method('PUT')
        @csrf
        <!--Modal body-->
            ...
            <div class="mt-5 w-full px-2 h-[46px]">
                <x-input-label class="px-2" for="estadodoc" :value="__('Estado')" />
                <select 
                    name="estadodoc" id="estadodoc" 
