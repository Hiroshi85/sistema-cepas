        ...
        <tbody>
            ...
            class="border-b transition duration-300 ease-in-out hover:bg-neutral-100 dark:border-neutral-500 dark:hover:bg-neutral-600">
                ...
                <td class="whitespace-nowrap px-6 py-4">
                    ...
                    data-te-target="#modalEdit-AP{{$item->idapoderado}}{{$item->idpostulante}}"
                    data-te-ripple-init
                    ...
                    <x-danger-button
                        data-te-toggle="modal"
                        data-te-target="#exampleModalCenter-ParentP{{$item->idapoderado}}"
                        data-te-ripple-init
                        data-te-ripple-color="light"
                    >
            ...
            <x-modal-delete :id="$item->idapoderado" :ids="$item->idpostulante" :entity="'ParentP'" :route="'parentesco.destroy'" :element="$item->nombre_apellidos"></x-modal-delete>
            @include('admision-matriculas.parentesco.partials.update', ['item' => $item, 'apoderado' => $apoderado, 'entity' => 'AP'])
