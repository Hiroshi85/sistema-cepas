<section class="overflow-hidden overflow-x-auto">
    ...
    <div class="my-2">
        ...
        <div class="!visible hidden px-16" id="collapseExample" data-te-collapse-item>
            <form method="POST" action="{{ route('docsalumno.store') }}" enctype="multipart/form-data">
                @csrf
                <!-- Name -->
    ...
    <table class="min-w-full text-left text-sm font-light pb-16 text-center text-gray-900 dark:text-gray-100">
        ...
        <tbody>
            ...
            <x-modal-delete :id="$item->iddocumento" :entity="'Doc'" :route="'docsalumno.destroy'" :element="$item->descripcion"></x-modal-delete>
            @include('admision-matriculas.alumno.partials.update-doc', ['item' => $item])
            {{-- ELIMINAR --}}
