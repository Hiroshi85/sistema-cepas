<x-modal-new :entity="'Admision'">
    <div class="pointer-events-auto relative flex w-full flex-col rounded-md border-none bg-white bg-clip-padding text-current shadow-lg outline-none dark:bg-gray-900">
    <div
        ...
        <!--Modal title-->
        <span class="text-xl mx-auto uppercase dark:text-white">Registrar Admisión</span>
        <!--Close button-->
        <button
        type="button"
    ...
    <form  method="POST" action="{{ route('admision.store') }}">
        @csrf
        <!--Modal body-->
        {{-- <div class="mx-4 my-2">
        ...
        <div class="mx-4 mb-2 flex gap-2">
            ...
            <x-text-input id="estado" class="block mt-1 w-full dark:text-white" type="text" name="estado" required autofocus/>
